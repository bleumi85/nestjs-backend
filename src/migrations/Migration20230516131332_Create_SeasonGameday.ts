...
export class Migration20230516131332_Create_SeasonGameday extends Migration {
  ...
  async up(): Promise<void> {
    this.addSql('create table "seasons_gamedays" ("id" uuid not null default gen_random_uuid(), "season_id" uuid not null, "gameday_id" uuid not null, "date_start" timestamptz(0), "date_end" timestamptz(0), constraint "seasons_gamedays_pkey" primary key ("id"));');
